                            ...
                            <div class="col-6">
                                <div class="card">
                                    <div class="card-body" style="padding-bottom:5px;!important">
                                        ...
                                        <form action="#" name="InputCacheCheck" method="post">
                                            <div class="input-prepend input-append" style="padding:5px;!important">
                                                ...
                                                <div class="btn-group mb-2">
                                                    ...
                                                    <span id="myInput" class="caret"></span>
                                                    </button>
                                        ...
                                        <br>
                                        <br>
                                        <button type="button" class="btn btn-info btn-lg btn-block waves-effect waves-light float-end" onclick="myFunction()">Add Class</button>
