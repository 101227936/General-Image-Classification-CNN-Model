...
<html lang="en">
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="Logo/faviconLogo.ico">
        ...
        <nav class="navbar navbar-expand-lg fixed-top navbar-custom sticky sticky-dark">
            <div class="container-fluid">
                ...
                <a class="logo text-uppercase" href="index.html">
                    <img src="Logo/light-logo.png" alt="" class="logo-light" height="21" style="max-width: 404px;height: 70px;" />
                    
                    <img src="Logo/dark-logo.png" alt="" class="logo-dark" height="21" style="max-width: 404px;height: 70px;" />
                </a>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-4 offset-xl-2 col-lg-5 offset-lg-1 col-md-7">
                                <div class="home-img position-relative">
                                    <img src="images/Home1.png" alt="" class="home-first-img">
                                    <img src="images/Home2.png" alt="" class="home-second-img mx-auto d-block">
                                    <img src="images/Home3.png" alt="" class="home-third-img">
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="features-box">
                            <div class="features-img mb-4">
                                <img src="images/icons/connections.png" alt="">
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="features-box">
                            <div class="features-img mb-6">
                                <img src="images/icons/financestat.png" alt="">
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="demo-box bg-white mt-4 p-2">
                            <img src="images/Tutorial1.png" alt="" class="img-fluid mx-auto d-block">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="demo-box bg-white mt-4 p-2">
                            <img src="images/Tutorial2.png" alt="" class="img-fluid mx-auto d-block">
                            <div class="p-3" style="padding-bottom: 8px!important;">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="demo-box bg-white mt-4 p-2">
                            <img src="images/Tutorial3.png" alt="" class="img-fluid mx-auto d-block">
                            <div class="p-3" style="padding-bottom: 8px!important;">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="features-box">
                            <div class="features-img mb-6">
                                <img src="TeamPhoto/Elaine.jpg" alt="" class="img-fluid rounded-circle" style="max-height:100px;width:100px;">
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="features-box">
                            <div class="features-img mb-6">
                                <img src="TeamPhoto/Chua.jpg" alt="" class="img-fluid rounded-circle" style="max-height:100px">
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="features-box">
                            <div class="features-img mb-6">
                                <img src="TeamPhoto/Harold.jpg" alt="" class="img-fluid rounded-circle" style="max-height:100px; width:100px;">
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="features-box">
                            <div class="features-img mb-6">
                                <img src="TeamPhoto/Jasmin.jpg" alt="" class="img-fluid rounded-circle" style="max-height:100px">
                            </div>
